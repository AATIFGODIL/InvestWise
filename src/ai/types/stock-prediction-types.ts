...
/**
 * Defines the schema for the input provided by the user to the main stock prediction flow.
 */
...
/**
 * Defines the schema for the raw, unprocessed output received from the external prediction API tool.
 */
...
/**
 * Defines the schema for the final, interpreted output that is sent back to the user interface.
