...
export default function ResearchClient() {
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    "grid gap-4 transition-all duration-700 ease-[cubic-bezier(0.25,1,0.5,1)]",
                    getGridClass(),
                    // In fullscreen, flex to fill available height. Otherwise min-height.
                    isCustomZoom ? "flex-1 min-h-[calc(100vh-8rem)]" : "min-h-[600px]"
                )}
            >
